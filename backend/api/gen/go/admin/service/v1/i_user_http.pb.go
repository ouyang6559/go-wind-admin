...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/users", _UserService_List27_HTTP_Handler(srv))
	r.GET("/admin/v1/users/username/{username}", _UserService_Get29_HTTP_Handler(srv))
	r.GET("/admin/v1/users/{id}", _UserService_Get30_HTTP_Handler(srv))
	r.POST("/admin/v1/users", _UserService_Create20_HTTP_Handler(srv))
	r.PUT("/admin/v1/users/{id}", _UserService_Update20_HTTP_Handler(srv))
	r.DELETE("/admin/v1/users/username/{username}", _UserService_Delete20_HTTP_Handler(srv))
	r.DELETE("/admin/v1/users/{id}", _UserService_Delete21_HTTP_Handler(srv))
...
func _UserService_List27_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
...
func _UserService_Create20_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Update20_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
