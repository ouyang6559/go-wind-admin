...
func (_u *RoleMetadataUpdate) SetCustomOverrides(v *schema.RoleOverride) *RoleMetadataUpdate {
...
// SetCustomOverrides sets the "custom_overrides" field.
func (_u *RoleMetadataUpdateOne) SetCustomOverrides(v *schema.RoleOverride) *RoleMetadataUpdateOne {
	_u.mutation.SetCustomOverrides(v)
	return _u
}
...
func (_u *RoleMetadataUpdateOne) sqlSave(ctx context.Context) (_node *RoleMetadata, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "RoleMetadata.id" for update`)}
	}
