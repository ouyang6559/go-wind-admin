...
const (
	// Label holds the string label denoting the userorgunit type in the database.
	Label = "user_org_unit"
...
// Columns holds all SQL columns for userorgunit fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
//
//	import _ "go-wind-admin/backendz/internal/ent/gen/runtime"
var (
	Hooks  [1]ent.Hook
	Policy ent.Policy
...
// OrderOption defines the ordering options for the UserOrgUnit queries.
