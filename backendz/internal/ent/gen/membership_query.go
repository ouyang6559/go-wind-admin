...
func (_q *MembershipQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *MembershipQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *MembershipQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *MembershipQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *MembershipQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *MembershipQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MembershipQuery) prepareQuery(ctx context.Context) error {
	...
	if membership.Policy == nil {
		return errors.New("gen: uninitialized membership.Policy (forgotten import gen/runtime?)")
	}
	if err := membership.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *MembershipQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(membership.Table, membership.Columns, sqlgraph.NewFieldSpec(membership.FieldID, field.TypeUint32))
	_spec.From = _q.sql
