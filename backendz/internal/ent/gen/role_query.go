...
func (_q *RoleQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *RoleQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *RoleQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *RoleQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *RoleQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *RoleQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RoleQuery) prepareQuery(ctx context.Context) error {
	...
	if role.Policy == nil {
		return errors.New("gen: uninitialized role.Policy (forgotten import gen/runtime?)")
	}
	if err := role.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
