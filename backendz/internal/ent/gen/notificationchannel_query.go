...
func (_q *NotificationChannelQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *NotificationChannelQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *NotificationChannelQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *NotificationChannelQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *NotificationChannelQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *NotificationChannelQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NotificationChannelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(notificationchannel.Table, notificationchannel.Columns, sqlgraph.NewFieldSpec(notificationchannel.FieldID, field.TypeUint32))
	_spec.From = _q.sql
