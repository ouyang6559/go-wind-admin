...
func (_u *OperationAuditLogUpdate) SetGeoLocation(v *schema.GeoLocation) *OperationAuditLogUpdate {
...
func (_u *OperationAuditLogUpdate) SetDeviceInfo(v *schema.DeviceInfo) *OperationAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *OperationAuditLogUpdateOne) SetGeoLocation(v *schema.GeoLocation) *OperationAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *OperationAuditLogUpdateOne) SetDeviceInfo(v *schema.DeviceInfo) *OperationAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
...
func (_u *OperationAuditLogUpdateOne) sqlSave(ctx context.Context) (_node *OperationAuditLog, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "OperationAuditLog.id" for update`)}
	}
