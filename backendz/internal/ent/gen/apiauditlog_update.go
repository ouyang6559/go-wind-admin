...
func (_u *ApiAuditLogUpdate) SetGeoLocation(v *schema.GeoLocation) *ApiAuditLogUpdate {
...
func (_u *ApiAuditLogUpdate) SetDeviceInfo(v *schema.DeviceInfo) *ApiAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *ApiAuditLogUpdateOne) SetGeoLocation(v *schema.GeoLocation) *ApiAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *ApiAuditLogUpdateOne) SetDeviceInfo(v *schema.DeviceInfo) *ApiAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
...
func (_u *ApiAuditLogUpdateOne) sqlSave(ctx context.Context) (_node *ApiAuditLog, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "ApiAuditLog.id" for update`)}
	}
