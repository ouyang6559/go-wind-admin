...
type DataAccessAuditLog struct {
	...
	// 地理位置(来自IP库)
	GeoLocation *schema.GeoLocation `json:"geo_location,omitempty"`
	// 设备信息
	DeviceInfo *schema.DeviceInfo `json:"device_info,omitempty"`
	// 全局请求ID
...
func (_m *DataAccessAuditLog) Unwrap() *DataAccessAuditLog {
	...
	if !ok {
		panic("gen: DataAccessAuditLog is not a transactional entity")
	}
