...
func (_q *UserCredentialQuery) prepareQuery(ctx context.Context) error {
	...
	if usercredential.Policy == nil {
		return errors.New("gen: uninitialized usercredential.Policy (forgotten import gen/runtime?)")
	}
	if err := usercredential.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
