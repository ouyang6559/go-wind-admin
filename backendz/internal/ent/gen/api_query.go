...
func (_q *APIQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *APIQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *APIQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *APIQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *APIQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *APIQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *APIQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(api.Table, api.Columns, sqlgraph.NewFieldSpec(api.FieldID, field.TypeUint32))
	_spec.From = _q.sql
