...
func (_u *LoginAuditLogUpdate) SetGeoLocation(v *schema.GeoLocation) *LoginAuditLogUpdate {
...
func (_u *LoginAuditLogUpdate) SetDeviceInfo(v *schema.DeviceInfo) *LoginAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *LoginAuditLogUpdateOne) SetGeoLocation(v *schema.GeoLocation) *LoginAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *LoginAuditLogUpdateOne) SetDeviceInfo(v *schema.DeviceInfo) *LoginAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
...
func (_u *LoginAuditLogUpdateOne) sqlSave(ctx context.Context) (_node *LoginAuditLog, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "LoginAuditLog.id" for update`)}
	}
