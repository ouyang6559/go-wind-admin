...
func (_q *RolePermissionQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *RolePermissionQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *RolePermissionQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *RolePermissionQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *RolePermissionQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *RolePermissionQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(rolepermission.FieldCreatedAt).
//		Aggregate(gen.Count()).
//		Scan(ctx, &v)
...
//
//	client.RolePermission.Query().
//		Select(rolepermission.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *RolePermissionQuery) prepareQuery(ctx context.Context) error {
	...
	if rolepermission.Policy == nil {
		return errors.New("gen: uninitialized rolepermission.Policy (forgotten import gen/runtime?)")
	}
...
func (_q *RolePermissionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(rolepermission.Table, rolepermission.Columns, sqlgraph.NewFieldSpec(rolepermission.FieldID, field.TypeUint32))
	_spec.From = _q.sql
