...
func (_q *UserRoleQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *UserRoleQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *UserRoleQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *UserRoleQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *UserRoleQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *UserRoleQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserRoleQuery) prepareQuery(ctx context.Context) error {
	...
	if userrole.Policy == nil {
		return errors.New("gen: uninitialized userrole.Policy (forgotten import gen/runtime?)")
	}
	if err := userrole.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *UserRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userrole.Table, userrole.Columns, sqlgraph.NewFieldSpec(userrole.FieldID, field.TypeUint32))
	_spec.From = _q.sql
