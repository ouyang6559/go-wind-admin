...
func (_u *DataAccessAuditLogUpdate) SetGeoLocation(v *schema.GeoLocation) *DataAccessAuditLogUpdate {
...
func (_u *DataAccessAuditLogUpdate) SetDeviceInfo(v *schema.DeviceInfo) *DataAccessAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *DataAccessAuditLogUpdateOne) SetGeoLocation(v *schema.GeoLocation) *DataAccessAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *DataAccessAuditLogUpdateOne) SetDeviceInfo(v *schema.DeviceInfo) *DataAccessAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
...
func (_u *DataAccessAuditLogUpdateOne) sqlSave(ctx context.Context) (_node *DataAccessAuditLog, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "DataAccessAuditLog.id" for update`)}
	}
