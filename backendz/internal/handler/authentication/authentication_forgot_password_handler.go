...
func AuthenticationForgotPasswordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := authentication.NewAuthenticationForgotPasswordLogic(r.Context(), svcCtx)
		err := l.AuthenticationForgotPassword(&req)
		if err != nil {
			xhttp.JsonBaseResponseCtx(r.Context(), w, err)
		} else {
