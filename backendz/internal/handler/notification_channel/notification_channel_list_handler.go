...
func NotificationChannelListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := notification_channel.NewNotificationChannelListLogic(r.Context(), svcCtx)
		resp, err := l.NotificationChannelList(&req)
		if err != nil {
			xhttp.JsonBaseResponseCtx(r.Context(), w, err)
		} else {
